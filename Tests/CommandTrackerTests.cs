...
public class CommandTrackerTests
{
    public static void Run()
    {
        ...
        // (Removed: UserCmdsSinceLastAi provenance counter tests. Drift
        // detection moved to the proxy as direct cwd comparison — the
        // tracker no longer carries a per-event user-command counter.)
